...
class Tipo(models.Model): # Tipos (Camisa, Camiseta, Bermuda, Calça)
  nome = models.CharField(max_length=200, null=True, blank=True)
...
class Produto(models.Model):
  ...
  tipop = models.ForeignKey(Tipo, null=True, blank=True, on_delete=models.SET_NULL)

  def __str__(self):
    return f"Nome: {self.nome}, Categoria: {self.categoria}, Tipo: {self.tipop} Preço: {self.preco}"
